var iNettuts = {
    ...
    settings : {
        ...
        optionSelector: '.widget-head .options',
    ...
    addWidgetControls : function () {
        ...
        $(settings.widgetSelector, $(settings.columns)).each(function () {
            ...
            var hidden = $(this).find('.widget-hidden').length > 0;
            var cls = 'fa-chevron-circle-' + (hidden ? 'down' : 'up');
            
            if (thisWidgetSettings.collapsible) {
                var collapse = $('<a href="#"><i class="fa ' + cls + '"></i></a>').mousedown(function (e) {
                    e.stopPropagation();    
                ...
                $(collapse).bind('click', function() {
                    ...
                    if ($(collapse).parents(settings.widgetSelector).find(settings.contentSelector).is(':hidden'))
                    {
                        ...
                        $(collapse).find('.fa').removeClass('fa-flip-vertical');
                    ...
                    else
                    {
                        ...
                        $(collapse).find('.fa').addClass('fa-flip-vertical');
                    }
                    return false;
                });
            }
            ...
            if (thisWidgetSettings.removable) {
                $('<a href="#"><i class="fa fa-times"></i></a>').mousedown(function (e) {
                    e.stopPropagation();    
                }).click(function () {
