...
class clsTableUpdater extends xajaxResponsePlugin
{
    ...
    */
    public function clsTableUpdater()
    {
        $this->sDefer = '';
        $this->sJavascriptURI = '';
    ...
    */
    ...
    // tables
    public function appendTable($table, $parent)
    {
        $command = array(
                'cmd'=>'et_at',
                'id'=>$parent
    ...
    public function insertTable($table, $parent, $position)
    {
        $command = array(
                'cmd'=>'et_it',
                'id'=>$parent,
    ...
    // rows
    public function appendRow($row, $parent, $position = null)
    {
        $command = array(
                'cmd'=>'et_ar',
                'id'=>$parent
    ...
    public function insertRow($row, $parent, $position = null, $before = null)
    {
        $command = array(
                'cmd'=>'et_ir',
                'id'=>$parent
    ...
    public function replaceRow($row, $parent, $position = null, $before = null)
    {
        $command = array(
                'cmd'=>'et_rr',
                'id'=>$parent
    ...
    public function deleteRow($parent, $position = null)
    {
        $command = array(
                'cmd'=>'et_dr',
                'id'=>$parent
    ...
    public function assignRow($values, $parent, $position = null, $start_column = null)
    {
        $command = array(
                'cmd'=>'et_asr',
                'id'=>$parent
    ...
    public function assignRowProperty($property, $value, $parent, $position = null)
    {
        $command = array(
                'cmd'=>'et_asrp',
                'id'=>$parent,
    ...
    // columns
    public function appendColumn($column, $parent, $position = null)
    {
        $command = array(
                'cmd'=>'et_acol',
                'id'=>$parent
    ...
    public function insertColumn($column, $parent, $position = null)
    {
        $command = array(
                'cmd'=>'et_icol',
                'id'=>$parent
    ...
    public function replaceColumn($column, $parent, $position = null)
    {
        $command = array(
                'cmd'=>'et_rcol',
                'id'=>$parent
    ...
    public function deleteColumn($parent, $position = null)
    {
        $command = array(
                'cmd'=>'et_dcol',
                'id'=>$parent
    ...
    public function assignColumn($values, $parent, $position = null, $start_row = null)
    {
        $command = array(
                'cmd'=>'et_ascol',
                'id'=>$parent
    ...
    public function assignColumnProperty($property, $value, $parent, $position = null)
    {
        $command = array(
                'cmd'=>'et_ascolp',
                'id'=>$parent,
