...
class clsValidator
{
    public $aTags;
    public $aAttributes;
    public $aRequiredAttributes;
    
    public function clsValidator()
    {
        global $aTags;
        global $aAttributes;
    ...
    public function _expand(&$aDestination, &$aSource, &$aDictionary)
    {
    ...
    public function elementValid($sElement)
    {
        return isset($this->aTags[strtoupper($sElement)]);
    }
    
    public function attributeValid($sElement, $sAttribute)
    {
    ...
    public function childValid($sParent, $sElement)
    {
    ...
    public function checkRequiredAttributes($sElement, &$aAttributes, &$sMissing)
    {
