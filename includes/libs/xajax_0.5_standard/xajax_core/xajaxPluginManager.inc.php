...
class xajaxPluginManager
{
    ...
    */
    public function _insertIntoArray(&$aPlugins, &$objPlugin, $nPriority)
    {
    ...
    */
    public function registerPlugin(&$objPlugin, $nPriority=1000)
    {
        if (is_a($objPlugin, 'xajaxRequestPlugin')) {
        ...
        } elseif (is_a($objPlugin, 'xajaxResponsePlugin')) {
            ...
            trigger_error(
                ...
                . get_class($objPlugin)
                . $objLanguageManager->getText('XJXPM:IPLGERR:02'), E_USER_ERROR
                );
//EndSkipDebug
        }
...
//SkipDebug
        ...
        trigger_error(
            ...
            . print_r($aArgs, true), E_USER_ERROR
            );
//EndSkipDebug
    }
