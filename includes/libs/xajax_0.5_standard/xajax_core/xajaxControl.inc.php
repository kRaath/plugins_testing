...
class xajaxControl
{
    ...
    */
    public function __construct($sTag, $aConfiguration=array())
    {
        ...
        } elseif (isset($aConfiguration['events'])) {
        ...
        if (class_exists('clsValidator')) {
            ...
            if (false == $objValidator->attributeValid($this->sTag, $sName)) {
                ...
                trigger_error(
                    ...
                    . $this->sTag
                    . $objLanguageManager->getText('XJXCTL:IAERR:03'), E_USER_ERROR
                    );
            }
        }
//EndSkipDebug
        ...
        if (class_exists('clsValidator')) {
            ...
            if (false == $objValidator->attributeValid($this->sTag, $sEvent)) {
                ...
                trigger_error(
                    ...
                    . $this->sTag
                    . $objLanguageManager->getText('XJXCTL:IEERR:03'), E_USER_ERROR
                    );
            }
        }
//EndSkipDebug
        ...
        if (class_exists('clsValidator')) {
            ...
            if (false == $objValidator->checkRequiredAttributes($this->sTag, $this->aAttributes, $sMissing)) {
                ...
                trigger_error(
                    ...
                    . $this->sTag
                    . $objLanguageManager->getText('XJXCTL:MAERR:03'), E_USER_ERROR
                    );
            }
        }
//EndSkipDebug
        ...
        if ('%inline' != $sClass) {// this odd syntax is necessary to detect request for no formatting
        ...
        if ('forbidden' == $this->sEndTag) {
            if ('HTML' == XAJAX_HTML_CONTROL_DOCTYPE_FORMAT) {
                echo '>';
            } elseif ('XHTML' == XAJAX_HTML_CONTROL_DOCTYPE_FORMAT) {
                echo '/>';
            }
...
//EndSkipDebug
    ...
    public function _printAttributes()
    {
...
class xajaxControlContainer extends xajaxControl
{
    ...
    */
    public function __construct($sTag, $aConfiguration=array())
    {
        ...
        } elseif (isset($aConfiguration['children'])) {
    ...
    */
    public function getClass()
    {
        ...
        } elseif (0 == count($this->aChildren) || '%inline' == $sClass || '%block' == $sClass) {
            return $sClass;
        }
    ...
    */
    public function getContentClass()
    {
        ...
        foreach (array_keys($this->aChildren) as $sKey) {
            ...
            } elseif ($sClass != $this->aChildren[$sKey]->getClass()) {
                return '%flow';
            }
        }
        ...
        if (class_exists('clsValidator')) {
            ...
            if (false == $objValidator->checkRequiredAttributes($this->sTag, $this->aAttributes, $sMissing)) {
                ...
                trigger_error(
                    ...
                    . $this->sTag
                    . $objLanguageManager->getText('XJXCTL:MRAERR:03'), E_USER_ERROR
                    );
            }
        }
//EndSkipDebug
...
//EndSkipDebug
        ...
        if ('%inline' != $sContentClass) {// this odd syntax is necessary to detect request for no formatting
            if (false === (false === $sIndent)) {
                echo "\n";
            }
        }
    ...
    {
        if (false == is_a($this, 'clsDocument')) {// this odd syntax is necessary to detect request for no formatting
            if (false === (false === $sIndent)) {
                $sIndent .= "\t";
            }
        }
