...
class nusoap_base
{
    ...
    */
    ...
    {
        $str = StringHandler::htmlspecialchars($str);
        return nl2br($str);
    }
            ...
            foreach ($this->bindings as $bindingName => $attrs) {
                ...
                foreach ($attrs['operations'] as $opName => $opParts) {
                    ...
                    if (isset($opParts['documentation']) && $opParts['documentation'] != '') {
                        $portType_xml .= "\n" . '    <documentation>' . StringHandler::htmlspecialchars($opParts['documentation']) . '</documentation>';
                    }
...
class nusoap_parser extends nusoap_base
{
    ...
    */
    public function start_element($parser, $name, $attrs)
    {
        ...
        // set name
        $this->message[$pos]['name'] = StringHandler::htmlspecialchars($name);
        // set attrs
