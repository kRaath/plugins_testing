...
public function init()
{
  ...
  $this->draw_title();
        ...
        if ($this->calculated['y_axis_left']['has_data']) {
            $this->draw_zero_axis_left();
        }  // either draw zero axis on left
  elseif ($this->calculated['y_axis_right']['has_data']) {
      $this->draw_zero_axis_right();
  } // ... or right.
  $this->draw_legend();
...
public function plot($x, $y, $type, $size, $colour, $offset)
{
  ...
  if ($this->parameter['zero_axis'] != 'none') {
    ...
    public function line($x_start, $y_start, $x_end, $y_end, $type, $brush_type, $brush_size, $colour, $offset)
    {
...
public function draw_brush_line($x0, $y0, $x1, $y1, $size, $type, $colour)
{
  ...
  $this->draw_brush($x0, $y0, $size, $type, $colour);
    ...
    public function draw_brush($x, $y, $size, $type, $colour)
    {
        $x = round($x);
        $y = round($y);
        $half = round($size / 2);
