...
class PayPalPlus extends PaymentMethod
{
    ...
    public function isConfigured()
    {
        ...
        try {
            ...
            throw new Exception($this->getExceptionMessage($ex));
        }
    }
    ...
    public function createPayment()
    {
        ...
        $transaction->setAmount($amount)
            ...
            ->setInvoiceNumber($this->getOrderNumber(true));
        ...
        try {
            ...
            if ($payment->getState() == 'created') {
                ...
                if ($payment->getState() === 'approved') {
                    $ip           = new stdClass();
                    $ip->cHinweis = $payment->getId();
                    $ip->cISO     = $basket->currency->cISO;
                    $ip->cZahler  = $_SESSION['reshash']['Payer'];
