...
class LPADatabase {
    ...
    public function getOrders($getBestellung = true) {
        $sql = "SELECT * FROM " . S360_LPA_TABLE_ORDER . " WHERE bSandbox = " . $this->getSandboxFlag();
    ...
    public function getAuthorizations() {
        $sql = "SELECT * FROM " . S360_LPA_TABLE_AUTHORIZATION . " WHERE bSandbox = " . $this->getSandboxFlag();
        $result = Shop::DB()->query($sql, 2);
        if ($result) {
            return $result;
        }
    ...
    public function getAuthorizationsForOrder($orid) {
        $sql = "SELECT * FROM " . S360_LPA_TABLE_AUTHORIZATION . "," . S360_LPA_TABLE_ORDER . " WHERE " . S360_LPA_TABLE_ORDER . ".cOrderReferenceId = " . S360_LPA_TABLE_AUTHORIZATION . ".cOrderReferenceId AND " . S360_LPA_TABLE_ORDER . ".cOrderReferenceId LIKE '{$orid}'";
        $result = Shop::DB()->query($sql, 2);
        if ($result) {
            return $result;
        }
    ...
    public function getCaptures() {
        $sql = "SELECT * FROM " . S360_LPA_TABLE_CAPTURE . " WHERE bSandbox = " . $this->getSandboxFlag();
        $result = Shop::DB()->query($sql, 2);
        if ($result) {
            return $result;
        }
    ...
    public function getCapturesForAuthorization($authid) {
        $sql = "SELECT * FROM " . S360_LPA_TABLE_CAPTURE . "," . S360_LPA_TABLE_AUTHORIZATION . " WHERE " . S360_LPA_TABLE_AUTHORIZATION . ".cAuthorizationId = " . S360_LPA_TABLE_CAPTURE . ".cAuthorizationId AND " . S360_LPA_TABLE_AUTHORIZATION . ".cAuthorizationId LIKE '{$authid}'";
        $result = Shop::DB()->query($sql, 2);
        if ($result) {
            return $result;
        }
    ...
    public function getRefunds() {
        $sql = "SELECT * FROM " . S360_LPA_TABLE_REFUND . " WHERE bSandbox = " . $this->getSandboxFlag();
        $result = Shop::DB()->query($sql, 2);
        if ($result) {
            return $result;
        }
    ...
    public function getRefundsForCapture($capid) {
        $sql = "SELECT * FROM " . S360_LPA_TABLE_REFUND . "," . S360_LPA_TABLE_CAPTURE . " WHERE " . S360_LPA_TABLE_CAPTURE . ".cCaptureId = " . S360_LPA_TABLE_REFUND . ".cCaptureId AND " . S360_LPA_TABLE_CAPTURE . ".cCaptureId LIKE '{$capid}'";
        $result = Shop::DB()->query($sql, 2);
        if ($result) {
            return $result;
        }
    ...
    public function getKundeForOrder($orid) {
        ...
        $sql = "SELECT * FROM tbestellung, {$orderTable} WHERE {$orderTable}.kBestellung = tbestellung.kBestellung AND {$orderTable}.cOrderReferenceId LIKE '{$orid}'";
        $result = Shop::DB()->query($sql, 1);
        if ($result) {
    ...
    public function getOrderReferenceIdByBestellNr($cBestellNr) {
        $sql = "SELECT * FROM " . S360_LPA_TABLE_ORDER . ", tbestellung WHERE tbestellung.kBestellung = " . S360_LPA_TABLE_ORDER . ".kBestellung AND tbestellung.cBestellNr LIKE '{$cBestellNr}'";
        $result = Shop::DB()->query($sql, 1);
        if ($result) {
