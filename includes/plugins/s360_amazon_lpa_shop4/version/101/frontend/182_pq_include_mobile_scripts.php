...
try {
    ...
    Shop::Smarty()->assign('lpa_login_redirect_uri', gibShopURL(true) . '/lpalogin'); // MUST BE SSL!
     ...
     */
    $lpa_other_urls['checkout'] = gibShopURL(true) . '/lpacheckout';
    ...
    if ($mode !== 'l' && $checkoutPossible) {
        ...
        if ($validCurrency && isset($_SESSION['Warenkorb']) && count($_SESSION['Warenkorb']->PositionenArr) > 0) {
            ...
            if ($bExclude) {
                ...
                Shop::Smarty()->assign('lpa_login_redirect_uri', gibShopURL(true) . '/lpacheckout'); // MUST BE SSL!
