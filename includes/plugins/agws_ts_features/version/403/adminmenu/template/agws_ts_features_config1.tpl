    ...
    {if $ts_id_all_arr|@count == 0}
        <div>
            ...
            <div id="ts-intro">
                ...
                Durch die Vorzertifizierung der Shop-Software profitieren Sie von <a href="http://www.trustedshops.de/shopbetreiber/index.html?registeredOffice=DEU&shopsw=JTL#offer&utm_source=JTL&utm_medium=backend&utm_content=link1&utm_campaign=part&a_aid=5591155a59851" target="_blank">besonders günstigen Konditionen <i class="fa fa-external-link" aria-hidden="true"></i></a>.
            </div>
        </div>
    ...
    <div id="ts-id-add">
        ...
        <form id="ts_id_add" name="ts_id_add" action="{$ts_id_add_form_action}" method="post">
            ...
            <div class="input_tsid">
                <input class="form-control" type="text" name="ts_id" id="ts_id" size="40" value="" placeholder="Trusted Shops ID einfügen…"/>
            </div>
            <div class="clear"></div>
            <div class="label_tssprache">Shop-Sprache:</div>
            <div class="select_tssprache">
                <select class="form-control" name="ts_sprache">
                    <option value="0" disabled {if isset($ts_id_all) && $ts_id_all->iTS_Sprache==0}selected="selected"{/if}>Bitte auswählen</option>
            ...
            <div class="btn_tsadd">
                <a class="btn btn-primary" href="javascript:;" onclick="document.getElementById('ts_id_add').submit();"><i class="fa fa-save fa-fw"></i>&nbsp;Hinzuf&uuml;gen</a>
            </div>
        </form>
    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form id="ts_id_delete_{$ts_id_all->cTS_ID}" name="ts_id_delete" action="{$ts_id_delete_form_action}" method="post">
                                        ...
                                        <a title="ID l&ouml;schen" class="btn btn-danger btn-sm" href="javascript:;" onclick="document.getElementById('ts_id_delete_{$ts_id_all->cTS_ID}').submit();"><i class="fa fa-trash-o fa-fw"></i></a>
                                    </form>
                                </td>
                            </tr>
                        {/foreach}
