        ...
        <form id="ts_id_options" name="ts_id_options" action="" method="post">
            {foreach from=$ts_id_all_arr item=ts_id_all}
                ...
                <div class="input_tsid">
                    <input class="form-control" type="text" name="ts_id" id="ts_id" size="50" readonly="readonly" value="{$ts_id}"/>
                </div>
                <div class="clear"></div>
                ...
                <span>So einfach nutzen Sie den Service von Trusted Shops (<a href="https://www.trustedshops.com/integration/?shop_id={$ts_id}&backend_language={$smarty.const.TS_URL_BACKEND_LANGUAGE}&shopsw={$smarty.const.TS_URL_SHOPSW}&shopsw_version={$smarty.const.TS_URL_SHOPSW_VERSION}&plugin_version={$smarty.const.TS_URL_PLUGIN_VERSION}&context=trustbadge" target="_blank">Integrationsanleitung <i class="fa fa-external-link" aria-hidden="true"></i></a>):</span><br>
                <ol>
                    <li style="list-style: outside none decimal; padding-left: 0px;">Erstellen Sie <a href="https://www.trustedshops.com/integration/?shop_id={$ts_id}&backend_language={$smarty.const.TS_URL_BACKEND_LANGUAGE}&shopsw={$smarty.const.TS_URL_SHOPSW}&shopsw_version={$smarty.const.TS_URL_SHOPSW_VERSION}&plugin_version={$smarty.const.TS_URL_PLUGIN_VERSION}&context=trustbadge" target="_blank">hier <i class="fa fa-external-link" aria-hidden="true"></i></a> zuerst Ihren individuellen Trustbadge Code</li>
                ...
                <div class="ts_badgecode">
                    <textarea class="form-control" rows="10" cols="120" name="ts_BadgeCode" placeholder="Bitte TrustBadge-Code hier einfügen ...">{$ts_id_all->cTS_BadgeCode}</textarea>
                </div>
                <span>
                ...
                <div style="width: 30%; float: right; text-align: left;">
                    ...
                    <div class="checkbox">
                        <label><input type="checkbox" name="ts_RatingWidgetShow" value="1" {if $ts_id_all->bTS_RatingWidgetShow==1}checked="checked"{/if}>aktiv, Anzeigeposition</label>
                    </div>
                ...
                <div style="width: 30%; float: right; text-align: left;">
                    ...
                    <div class="checkbox">
                        <label><input type="checkbox" name="ts_ReviewStickerShow" value="1" {if $ts_id_all->bTS_ReviewStickerShow==1}checked="checked"{/if}>aktiv, Anzeigeposition</label>
                    </div>
                ...
                <div style="width: 30%; float: right; text-align: left;">
                    ...
                    <div class="checkbox">
                        <label><input type="checkbox" name="ts_ProductStickerShow" value="1" {if $ts_id_all->bTS_ProductStickerShow==1}checked="checked"{/if}>aktiv, anzeigen bei</label>
                    </div>
                    <select class="form-control" name="ts_ProductStickerArt">
                ...
                <div style="width: 60%; float: left;">
                    ...
                    <small><a href="https://support.google.com/webmasters/answer/146750?hl=en" target="_blank">Google Rich Snippets Dokumentation <i class="fa fa-external-link" aria-hidden="true"></i></a></small>
                </div>
                <div style="width: 30%; float: right; text-align: left;">
                    <input type="hidden" name="ts_RichSnippetsCategory" value="0">
                    <div class="checkbox">
                        <label><input type="checkbox" name="ts_RichSnippetsCategory" value="1" {if $ts_id_all->bTS_RichSnippetsCategory==1}checked="checked"{/if}>Kategorieseiten</label>
                    </div>
                    <input type="hidden" name="ts_RichSnippetsProduct" value="0">
                    <div class="checkbox">
                        <label><input type="checkbox" name="ts_RichSnippetsProduct" value="1" {if $ts_id_all->bTS_RichSnippetsProduct==1}checked="checked"{/if}>Produktdetailseiten</label>
                    </div>
                    <input type="hidden" name="ts_RichSnippetsMain" value="0">
                    <div class="checkbox">
                        <label><input type="checkbox" name="ts_RichSnippetsMain" value="1" {if $ts_id_all->bTS_RichSnippetsMain==1}checked="checked"{/if}>Startseite (nicht empfohlen)</label>
                    </div>
                </div>
                <div class="clear vspacer10"></div>
                <div class="clear">
                ...
                <div id="hide_reviewstickercode">
                    <div>
                        ...
                        <textarea class="form-control" rows="10" cols="120" name="ts_ReviewStickerCode" placeholder="Bitte ReviewSticker-Code hier einfügen ...">{$ts_id_all->cTS_ReviewStickerCode}</textarea>
                    </div>
                    <div class="clear vspacer10"></div>
                    <div>
                ...
                <div class="tright btn-group right">
                    <a id="btn_ts_id_cancel" class="btn btn-danger" href="#" onclick="return false;"><i class="fa fa-ban fa-fw"></i>&nbsp;Abbrechen</a>
                    <a id="btn_ts_id_save" class="btn btn-primary" href="#" onclick="return false;"><i class="fa fa-save fa-fw"></i>&nbsp;Speichern</a>
                </div>
            {/foreach}
        </form>
