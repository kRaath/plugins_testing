        ...
        <form name="ts_id_options" action="" method="post">
            ...
            <fieldset>
                <ul class="input_block">
                    ...
                    <li>
                    <span style="float: left;">
                        Sofern keine weiteren Installationsschritte im Integration Center beschrieben wurden, wird das Trustbadge jetzt im Frontend Ihres Shops angezeigt.
                    </span>
                    </li>
                    <li class="spacer"></li>
                    <li>
                    ...
                    <div id="hide_reviewstickercode">
                        <li>
                            ...
                            <textarea rows="10" cols="120" style="margin: 20px 0;" name="ts_ReviewStickerCode" placeholder="Bitte ReviewSticker-Code hier einfügen ...">{$ts_id_all->cTS_ReviewStickerCode}</textarea>
                        </li>
                        <li class="clear">
