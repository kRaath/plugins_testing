...
class CategoryData implements IItemData
{
    ...
    private function getDefaultLanguage()
    {
        ...
        if ($bLanguage) {
            $this->oDebugger->doDebug(__FILE__ . ':' . __CLASS__ . '->' . __METHOD__ . '; Es ist ein Fehler beim Auswählen der Standardsprache aufgetreten: Keine Standardsprache vorhanden.');
            die('JTL-Search Fehler beim Datenexport: Keine Standard-Shopsprache vorhanden.');
        } else {
            $this->oDebugger->doDebug(__FILE__ . ':' . __CLASS__ . '->' . __METHOD__ . '; Es ist ein Fehler beim Auswählen der Standardsprache aufgetreten: Keine Sprachen vorhanden.');
