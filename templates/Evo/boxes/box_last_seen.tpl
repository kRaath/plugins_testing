...
{if isset($recentlyViewedArticles)}
    ...
    {include file='snippets/product_slider.tpl' id='boxslider-recently-viewed' productlist=$recentlyViewedArticles title=$slidertitle tplscope='box' hideOverlays=true}
{/if}
{/nocache}