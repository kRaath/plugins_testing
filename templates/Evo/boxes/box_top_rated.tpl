{if isset($oBox->oArtikel_arr)}
    ...
    {/if}
    {include file='snippets/product_slider.tpl' id='boxslider-toprated' productlist=$oBox->oArtikel_arr title=$slidertitle tplscope='box' moreLink=$moreLink moreTitle=$moreTitle}
    {*<a href="{$Boxen.TopBewertet->cURL}">{lang key="topReviews" section="global"}</a>*}
{elseif isset($Boxen.TopBewertet->oArtikel_arr)}
    {lang key="topReviews" section="global" assign='slidertitle'}
    {include file='snippets/product_slider.tpl' id='boxslider-toprated' productlist=$Boxen.TopBewertet->oArtikel_arr title=$slidertitle tplscope='box'}
    {*<a href="{$Boxen.TopBewertet->cURL}">{lang key="topReviews" section="global"}</a>*}
{/if}