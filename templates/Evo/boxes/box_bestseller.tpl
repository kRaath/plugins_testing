...
{if isset($bestsellerArticles)}
    ...
    {include file='snippets/product_slider.tpl' id='boxslider-bestsellers' productlist=$bestsellerArticles title=$slidertitle tplscope='box' moreLink=$moreLink moreTitle=$moreTitle}
{/if}
{*
